    ...
    <div class="animated fadeIn">
        ...
        <div class="row mt-4">
            <div class="col-lg-6 col-md-6">
                <div class="card ">
                    <div class="card-body">
                        <div class="stat-widget-five row">
                            <div class="stat-icon dib flat-color-1 col-2">
                                <i class="display-4 pe-7s-cash"></i>
                            </div>
                            <div class="stat-content col-10">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-five row">
                            <div class="col-2 stat-icon dib flat-color-2">
                                <i class="display-4 pe-7s-cart"></i>
                            </div>
                            <div class="col-10 stat-content">
                                <div class="text-left dib">
