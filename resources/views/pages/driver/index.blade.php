...
<script>
    $(document).ready(function () {
        ...
        $("#btnCreate").on('click', function () {
            // let is_create =
            $("#titleModal").html(`<h4 class="modal-title" >Tambah Driver</h4>
        ...
        $("#table").on('click', '#btnUpdate', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $("#titleModal").html(`<h4 class="modal-title" >Update Driver <small>${response.name}</small></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>`);
        ...
        $("#table").on('click', '#btnDelete', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    text: `Data Driver bernama ${name} akan dihapus`,
                    icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function (response) {
                                    Swal.fire(
                                        'Terhapus!',
                                        `Data Driver bernama ${name} berhasil di hapus.`,
                                        'success'
                                    )
                                    dataTable.ajax.reload();
                                }
